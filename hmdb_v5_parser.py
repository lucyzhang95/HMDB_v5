...
def manual_disease_name2id(disease_names: list[str]) -> dict:
    raw_mapping = {
        "early preeclampsia": None,
        "late-onset preeclampsia": None,
        "perillyl alcohol administration for cancer treatment": None,
        "ketotic hypoglycemia": None,
        "anoxia": None,
        "3-hydroxyisobutyric acid dehydrogenase deficiency": None,
        "septic shock": None,
        "smoking": None,
        "thymidine treatment": None,
        "attachment loss": None,
        "periodontal probing depth": None,
        "continuous ambulatory peritoneal dialysis": None,
        "hemodialysis": None,
        "hyperoxalemia": None,
        "missing teeth": None,
        "cerebral vasospasm": None,
        "methylmalonic aciduria mitochondrial encephelopathy leigh-like": None,
        "tooth decay": None,
        "functional hypothalamic amenorrhea": None,
        "stress": None,
        "peroxisomal disorders, new type, liver": None,
        "anemia": None,
        "convulsion": None,
        "hyperpipecolatemia": None,
        "dopamine-serotonin vesicular transport defect": None,
        "prosthesis/missing teeth": None,
        "small intestinal malabsorption": None,
        "cervical myelopathy": None,
        "transurethral resection of the prostate": None,
        "parkinsonian syndrome": None,
        "glucagon deficiency": None,
        "refractory localization-related epilepsy": None,
        "d-glyceric acidura": None,
        "intrahepatic biliary hypoplasia": None,
        "portal vein obstruction": None,
        "methyl formate exposure": None,
        "formic acid intoxication": None,
        "ethanolaminuria": None,
        "idiopathic oro-facial pain": None,
        "peritoneal dialysis": None,
        "supragingival calculus": None,
        "serine deficiency syndrome, infantile": None,
        "hepatic and biliary malignancies": None,
        "ethanol intoxication": None,
        "acute seizures": None,
        "critical illnesses": None,
        "supragingival plaque": None,
        "heat stress": None,
        "methamphetamine (map) psychosis": None,
        "sodium nitrate consumption": None,
        "nicotinamide adenine dinucleotide deficiency": None,
        "intraventricular hemorrhage": None,
        "cns infections": None,
        "homozygous sickle cell disease": None,
        "tetrahydrofuran exposure": None,
        "premenstrual dysphoric disorder": None,
        "prepartum depression": None,
        "hydrogen sulfide poisoning": None,
        "nucleotide depletion syndrome": None,
        "terminal aldosterone biosynthesis defects": None,
        "glutaryl-coa dehydrogenase deficiency (gdhd)": None,
        "anephric patients": None,
        "cancer with metastatic bone disease": None,
        "supradiaphragmatic malignancy": None,
        "rachialgia": None,
        "neuroinfection": None,
        "isopropyl alcohol poisoning": None,
        "preterm birth": None,
        "diarrhoea predominant irritable bowel syndrome": None,
        "dermal fibroproliferative disorder": None,
        "methotrexate treatment": None,
        "cardiopulmonary bypass": None,
        "d-lactic acidosis and short bowel syndrome": None,
        "glycerol intolerance syndrome": None,
        "pregnene hydroxylation deficiency": None,
        "oxidative stress": None,
        "tert-amyl-methyl ether exposed": None,
        "vessel occlusion": None,
        "ileocystoplasty": None,
        "cresol poisoning ibs": None,
        "ileostomy": None,
        "dimethyl sulfide poisoning": None,
        "cardiopulmonary resuscitation": None,
        "gamma-glutamyltransferase deficiency": None,
        "kidney transplantation": None,
        "testicular adrenal rest tumors": None,
        "mycobacterium tuberculosis": None,
        "angina": None,
        "eucalyptol exposure": None,
        "quetiapine poisoning": None,
    }
